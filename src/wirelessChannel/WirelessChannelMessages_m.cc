...
Register_Class(WirelessChannelUpdateMessage);

WirelessChannelUpdateMessage::WirelessChannelUpdateMessage(const char *name, int kind) : ::cMessage(name,kind)
{
    this->nodeID_var = 0;
    this->PLd0_VWC_var = 0;
}

WirelessChannelUpdateMessage::WirelessChannelUpdateMessage(const WirelessChannelUpdateMessage& other) : ::cMessage(other)
{
    copy(other);
}

WirelessChannelUpdateMessage::~WirelessChannelUpdateMessage()
{
}

WirelessChannelUpdateMessage& WirelessChannelUpdateMessage::operator=(const WirelessChannelUpdateMessage& other)
{
    if (this==&other) return *this;
    ::cMessage::operator=(other);
    copy(other);
...
void WirelessChannelUpdateMessage::copy(const WirelessChannelUpdateMessage& other)
{
    this->nodeID_var = other.nodeID_var;
    this->PLd0_VWC_var = other.PLd0_VWC_var;
}

void WirelessChannelUpdateMessage::parsimPack(cCommBuffer *b)
{
    ::cMessage::parsimPack(b);
    doPacking(b,this->nodeID_var);
    doPacking(b,this->PLd0_VWC_var);
}

void WirelessChannelUpdateMessage::parsimUnpack(cCommBuffer *b)
{
    ::cMessage::parsimUnpack(b);
    doUnpacking(b,this->nodeID_var);
    doUnpacking(b,this->PLd0_VWC_var);
}

int WirelessChannelUpdateMessage::getNodeID() const
{
    return nodeID_var;
}

void WirelessChannelUpdateMessage::setNodeID(int nodeID)
{
    this->nodeID_var = nodeID;
}

double WirelessChannelUpdateMessage::getPLd0_VWC() const
{
    return PLd0_VWC_var;
}

void WirelessChannelUpdateMessage::setPLd0_VWC(double PLd0_VWC)
{
    this->PLd0_VWC_var = PLd0_VWC;
}

class WirelessChannelUpdateMessageDescriptor : public cClassDescriptor
{
  public:
    WirelessChannelUpdateMessageDescriptor();
    virtual ~WirelessChannelUpdateMessageDescriptor();
...
Register_ClassDescriptor(WirelessChannelUpdateMessageDescriptor);

WirelessChannelUpdateMessageDescriptor::WirelessChannelUpdateMessageDescriptor() : cClassDescriptor("WirelessChannelUpdateMessage", "cMessage")
{
}

WirelessChannelUpdateMessageDescriptor::~WirelessChannelUpdateMessageDescriptor()
{
}

bool WirelessChannelUpdateMessageDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<WirelessChannelUpdateMessage *>(obj)!=NULL;
}

const char *WirelessChannelUpdateMessageDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int WirelessChannelUpdateMessageDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount(object) : 2;
}

unsigned int WirelessChannelUpdateMessageDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *WirelessChannelUpdateMessageDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int WirelessChannelUpdateMessageDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='n' && strcmp(fieldName, "nodeID")==0) return base+0;
    if (fieldName[0]=='P' && strcmp(fieldName, "PLd0_VWC")==0) return base+1;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *WirelessChannelUpdateMessageDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *WirelessChannelUpdateMessageDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int WirelessChannelUpdateMessageDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    WirelessChannelUpdateMessage *pp = (WirelessChannelUpdateMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string WirelessChannelUpdateMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: return long2string(pp->getNodeID());
        case 1: return double2string(pp->getPLd0_VWC());
        default: return "";
    }
}

bool WirelessChannelUpdateMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: pp->setNodeID(string2long(value)); return true;
        case 1: pp->setPLd0_VWC(string2double(value)); return true;
        default: return false;
    }
}

const char *WirelessChannelUpdateMessageDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *WirelessChannelUpdateMessageDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
