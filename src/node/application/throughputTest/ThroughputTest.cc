...
void ThroughputTest::finishSpecific() {
	...
	//Feito por Luan
	declareOutput("Bytes delivered");
	declareOutput("Bytes received");
	//collectOutput("Bytes received", "total", bytesReceived);
	...
	//Feito por Luan
	collectOutput("Bytes delivered", "total", bytesDelivered);
	collectOutput("Bytes received", "total", bytesReceived[0]);
