...
class SWPTMAC: public VirtualMac
{
...
class SWPTMACHeaderBase{// extends FieldsChunk{
	int srcAddr;
	int destAddr;
	SWPTMACType type;
};

class SWPTMACBeaconFrame: SWPTMACHeaderBase { };

class SWPTMACDataFrame: SWPTMACHeaderBase{
