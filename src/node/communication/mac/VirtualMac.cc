...
bool VirtualMac::isNeedEnergy()
{
    //send(macMsg, "toDroneModule");
    return resMgrModule->isNeedEnergy();
}

bool VirtualMac::requestEnergy()
{
    //send(macMsg, "toDroneModule");
    return resMgrModule->requestEnergy();
}

void VirtualMac::needEnergy()
{
    //send(macMsg, "toDroneModule");
    resMgrModule->needEnergy();
}
